...
```bash
# 1. Chạy backend trước (xem README backend)
git clone https://github.com/hdthinh3105-hub/automation-agent-BE.git
git clone https://github.com/hdthinh3105-hub/automation-agent-FE.git
